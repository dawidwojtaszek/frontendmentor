const AboutSection = () => (
  <div className="flex flex-col md:flex-row md:justify-between md:gap-[100px]">
    ...
    <div>
      <div className="w-full pl-4 mb-12 md:mb-10">
        <div className="w-full bg-brightRed/10 flex h-10 items-center md:bg-veryLightGray rounded-l-3xl">
