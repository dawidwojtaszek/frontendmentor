...
const HeroSection = () => (
  <div className="flex flex-col-reverse w-full items-center md:flex-row md:justify-between md:min-h-[700px]">
    <div className="max-w-[450px] flex flex-col items-center md:items-start">
      ...
      <p className="my-[40px] text-darkGrayishBlue md:max-w-[350px]">
